...
#Pulling up Selected item

def selected_item(a):
    curitem= tree.focus()
    selected_click = tree.item(curitem)['values'][2]
    print(selected_click) 
...
Options = ['abs','adductors','biceps','calves','cardiovascular system','delts','forearms','glutes','hamstrings','lats','pectorals','quads','spine','triceps','upper back']
clicked= StringVar()
...
#Hyper Link Double Click
tree.bind('<Double-1>', selected_item)
#
root.mainloop()